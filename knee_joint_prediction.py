...
# Model
model = torch.hub.load('ultralytics/yolov5', 'custom', path=r'D:\College\Sem 6\DL\Project\yolov5\runs\train\exp\weights\best.pt') 

# Image
im = r"D:\College\Sem 6\DL\Project\knee.png"
...
output_dir = r"D:\College\Sem 6\DL\Project\output_images"
